                  ...
                  child: ConstrainedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          constraints: BoxConstraints(
                            minHeight: (short * 0.145).clamp(48.0, 58.0),
                          ),
                        ...
                        GestureDetector(
                          onTap: () async {
                            ...
                            try {
                              ...
                              String shortDeviceType =
                                  deviceType.contains('Qlink')
                                  ? 'Qlink Bracelet'
                                  : 'Smart Watch';
                              ...
                              for (
                                int i = 0;
                                i < widget.emergencyContacts.length;
                                i++
                              ) {
                              ...
                              await SupabaseService().client
                                  ...
                                  .insert({
                                    ...
                                    'relationship_to_guardian':
                                        widget.relationship,
                                    'birth_year':
                                        int.tryParse(widget.birthYear) ?? 0,
                                    ...
                                    'status': true,
                                    'seo_slug':
                                        '${(widget.name).toLowerCase().replaceAll(' ', '-')}-${const Uuid().v4().substring(0, 6)}',
                                  });
                              ...
                              if (mounted) {
                                Navigator.pushAndRemoveUntil(
                                  ...
                                  MaterialPageRoute(
                                    builder: (_) =>
                                        const WearerMainPage(isConnected: true),
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.pushAndRemoveUntil(
                              ...
                              MaterialPageRoute(
                                builder: (_) =>
                                    const WearerMainPage(isConnected: false),
                                settings: const RouteSettings(
                                  name: 'WearerMainPage',
                                ),
                              ),
