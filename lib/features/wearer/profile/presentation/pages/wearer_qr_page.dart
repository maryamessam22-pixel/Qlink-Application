...
class _WearerQrPageState extends State<WearerQrPage> {
          ...
          return Column(
            children: [
              ...
              if (noProfile)
                ...
                GestureDetector(
                  onTap: () => _showScanAccessDialog(appState, qrPayload),
                  child: Container(
                    padding: EdgeInsets.all((short * 0.08).clamp(24.0, 36.0)),
                    decoration: BoxDecoration(
                      color: Colors.white,
                      borderRadius: BorderRadius.circular(
                        (w * 0.08).clamp(24.0, 36.0),
                      ),
                      boxShadow: [
                        BoxShadow(
      ...
      children: [
        MobileScanner(
          ...
          onDetect: (capture) async {
            ...
            _scanBusy = true;
            try {
              await _showScanAccessDialog(appState, raw);
            } finally {
        ...
        Positioned(
          ...
          child: Column(
            children: [
              ...
              SizedBox(
                height: (MediaQuery.of(context).size.shortestSide * 0.03).clamp(
                  8.0,
                  14.0,
                ),
              ),
              Padding(
                padding: EdgeInsets.symmetric(
                  horizontal: (MediaQuery.of(context).size.width * 0.1).clamp(
                    28.0,
                    46.0,
                  ),
                ),
                child: Text(
                  appState.tr(
                    'Scan another user\'s code to link accounts or view public info.',
                    'امسح رمز مستخدم آخر لربط الحسابات أو عرض المعلومات العامة.',
                  ),
                  textAlign: TextAlign.center,
              ...
              SizedBox(
                height: (MediaQuery.of(context).size.shortestSide * 0.12).clamp(
                  34.0,
                  52.0,
                ),
              ),
  ...
  Widget _buildScannerAction(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Icon(
          icon,
          color: isPrimary ? const Color(0xFF1B64F2) : Colors.white,
  ...
  Future<void> _showScanAccessDialog(AppState appState, String rawQr) async {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              appState.tr(
                'Please enter your phone number to securely access the scanned profile.',
                'يرجى إدخال رقم هاتفك للوصول الآمن إلى الملف الممسوح.',
              ),
              textAlign: TextAlign.center,
              style: TextStyle(
                fontSize: 14,
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText: appState.tr('+20 01012345678', '+20 01012345678'),
                filled: true,
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                if (phoneNumber.isEmpty || phoneNumber == '+20') {
                ...
                appState.addScanHistory(
                  ScanHistoryItem(
                    title: appState.tr('Bracelet Scanned!', 'تم مسح السوار!'),
                    scanner: phoneNumber,
                    location: 'Cairo, Egypt',
                    time: appState.tr('Just now', 'الآن'),
                  ),
                );

                if (!context.mounted) return;
                Navigator.pop(context);
                await navigateEmergencyPreviewFromQrRaw(
                  this.context,
                  rawQr,
                  scannerPhone: phoneNumber,
                );
              },
